...
title: |
  |
  | \vspace{1cm}Truth and bias: Biased findings^[Corresponding author: Bernhard Clemm von Hohenberg, bernhard.clemm@eui.eu. I am grateful to Paul Bauer, Aleksandra Cichocka, Diego Gambetta, Andrew Guess, Jennifer Jerit and John Jost for valuable feedback.]\vspace{0.5cm}
  |
  |
author: |
